          ...
          <div className='flex flex-col items-center justify-center w-full h-full relative'>
            ...
            >
                ...
                <div className='relative w-full h-full bg-background'>
                  {/* "Your Online Activity, Mass AI Automation" heading centered over video */}
                  ...
                  <div className="absolute inset-0 z-10 w-full h-full flex flex-col justify-center space-y-12 opacity-30 overflow-hidden">
